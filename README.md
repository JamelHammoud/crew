...
1. Download either the [MacOS](https://github.com/JamelHammoud/crew/releases/latest) or [Windows](https://github.com/JamelHammoud/crew/releases/latest) app from GitHub
