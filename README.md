...
<h4>
  <a href="https://github.com/JamelHammoud/crew/releases/download/v0.0.5/Crew-0.0.5-arm64.dmg">Download for Mac</a>
  ·
  <a href="https://github.com/JamelHammoud/crew/releases/download/v0.0.5/Crew-Setup-0.0.5.exe">Download for Windows</a>
</h4>
<hr/>
...
1. Download either the [MacOS](https://github.com/JamelHammoud/crew/releases/download/v0.0.5/Crew-0.0.5-arm64.dmg) or [Windows](https://github.com/JamelHammoud/crew/releases/download/v0.0.5/Crew-Setup-0.0.5.exe) app from GitHub
