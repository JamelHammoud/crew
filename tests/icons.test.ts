...
// A form drawn as one filled shape carries its whole box as ink rather than just
// its edge, so it is read against the solid keyline. The ellipsis dots are filled
