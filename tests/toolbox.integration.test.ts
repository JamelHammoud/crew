...
describe('toolbox', () => {
  ...
  it('turns away a tool that could not be pressed', async () => {
    ...
    sam.send({ type: 'tool.add', name: 'Mute', mark: 'globe', action: { kind: 'say', text: ' ' } })
    sam.send({ type: 'tool.add', name: 'Idle', mark: 'globe', action: { kind: 'todo', text: '' } })
    sam.send({ type: 'tool.add', name: 'Unwritten', mark: 'globe', action: { kind: 'note', page: 'notes', text: ' ' } })
    sam.send({ type: 'tool.add', name: 'Quiet', mark: 'globe', action: { kind: 'music' } })
    sam.send({ type: 'tool.add', name: 'Alone', mark: 'globe', action: { kind: 'chain', toolIds: [] } })
