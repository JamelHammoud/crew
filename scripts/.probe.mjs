...
body { margin: 0; background: #0c0d0e; color: #f5f5f5;
  font: 13px -apple-system, BlinkMacSystemFont, system-ui, sans-serif; padding: 24px; }
svg[class~="w-3"] { width: 12px; height: 12px; }
svg[class~="w-3.5"] { width: 14px; height: 14px; }
...
app.whenReady().then(async () => {
  const win = new BrowserWindow({ width: 1080, height: 1180, show: false, backgroundColor: '#0c0d0e' })
