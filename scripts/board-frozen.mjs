...
const driveSource = String.raw`(async () => {
  ...
  const heldEntries = editor.overlays.getActiveOverlayEntries.bind(editor.overlays)
  let frozenEntries = null
  editor.overlays.getActiveOverlayEntries = () => (frozenEntries = frozenEntries || heldEntries())
