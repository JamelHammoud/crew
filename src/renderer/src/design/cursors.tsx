...
const BEAM = 'M11 6H17V8H15V22H17V24H11V22H13V8H11Z'
...
const CLOSED_HAND = [
  box(4.4, 9.6, 15.2, 12.4, 5.4),
  box(5.6, 6.6, 2.9, 7, 1.45),
  box(9.2, 6.6, 2.9, 7, 1.45),
  box(12.8, 6.6, 2.9, 7, 1.45),
  box(16.4, 6.6, 2.9, 7, 1.45),
  box(3.2, 12.4, 8, 4.8, 2.4)
].join('')
