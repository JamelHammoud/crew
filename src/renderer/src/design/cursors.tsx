import type { TLCursorType } from 'tldraw'

export const ARROW_BODY =
...
export const ARROW_ON_GRID = 'translate(-2.9 -2.52) scale(.94)'
...
const CROSSHAIR = 'M13 7H15V14H22V16H15V23H13V16H6V14H13Z'
...
const PENCIL_PLACE = 'translate(3.8 4.6) scale(0.87)'
