  ...
  return (
    ...
    >
      <button
        ...
        className="absolute right-4 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-ink-800 text-danger ring-1 ring-inset ring-fg/10 transition-[color,background-color,clip-path,transform] duration-150 hover:bg-ink-700 active:scale-95 focus-visible:outline-none focus-visible:ring-fg/30"
      >
