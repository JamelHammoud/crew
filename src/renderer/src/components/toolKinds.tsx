...
export const TOOL_KINDS: Array<{ kind: ToolKind; title: string; note: string; mark: Glyph }> = [
  ...
  { kind: 'prompt', title: 'Start a thread', note: 'An agent takes it', mark: SparkGlyph },
  { kind: 'post', title: 'Send a message', note: 'An agent writes it', mark: SendGlyph },
  { kind: 'say', title: 'Say something', note: 'Your own words', mark: ChatGlyph },
