...
// service and this is it. The key is a client key, and it rides in the repo the
// crew already shares, which is how everyone who joined gets GIFs without being
// handed anything of their own. One free key from partner.klipy.com goes here.
const KEY = ''
