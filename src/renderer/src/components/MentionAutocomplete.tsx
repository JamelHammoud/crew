...
import { machineDirQuery, pathMenu } from '../../../shared/machinePath'
import { pathQuery, pathToken, type PathMatch } from '../../../shared/pathMention'
...
export function useMentionAutocomplete(
  ...
  const matches = useMemo<MentionItem[]>(() => {
    ...
    return []
  }, [agents, boards, dirQuery, docs, files, includeMembers, machine, members, query])
