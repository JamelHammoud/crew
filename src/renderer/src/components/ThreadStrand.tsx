...
export default function ThreadStrand({
  ...
  return (
    ...
    >
      {face}
      <span
        className={`min-w-0 flex-1 h-10 pl-3.5 pr-5 flex items-center gap-2.5 rounded-[20px] rounded-tl-2xl border text-sm transition-[background-color,border-color] duration-200 ${
