...
export default function ThreadStrand({
  ...
  return (
    ...
    >
      {face}
      <span
        className={`min-w-0 max-w-full h-9 pl-4 pr-3 flex items-center gap-2.5 rounded-[14px] border text-sm transition-[background-color,border-color] duration-200 ${
