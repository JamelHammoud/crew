...
export type ShapeColorVariant = 'solid' | 'fill' | 'linedFill' | 'semi' | 'pattern' | 'noteFill' | 'noteText' | 'frameStroke' | 'frameFill' | 'frameText' | 'highlightSrgb'
export type ShapeColorMode = 'light' | 'dark'

const NAMES: CrewColorStyle[] = ['black', 'grey', 'light-violet', 'violet', 'blue', 'light-blue', 'yellow', 'orange', 'green', 'light-green', 'light-red', 'red', 'white']

const LIGHT: Record<ShapeColorVariant, string[]> = {
  solid: ['#1d1d1d', '#9fa8b2', '#e085f4', '#ae3ec9', '#4465e9', '#4ba1f1', '#f1ac4b', '#e16919', '#099268', '#4cb05e', '#f87777', '#e03131', '#FFFFFF'],
  fill: ['#1d1d1d', '#9fa8b2', '#e085f4', '#ae3ec9', '#4465e9', '#4ba1f1', '#f1ac4b', '#e16919', '#099268', '#4cb05e', '#f87777', '#e03131', '#FFFFFF'],
  linedFill: ['#363636', '#bbc1c9', '#e9abf7', '#be68d4', '#6580ec', '#7abaf5', '#f5c27a', '#ea8643', '#0bad7c', '#7ec88c', '#f99a9a', '#e75f5f', '#ffffff'],
  semi: ['#e8e8e8', '#eceef0', '#f5eafa', '#ecdcf2', '#dce1f8', '#ddedfa', '#f9f0e6', '#f8e2d4', '#d3e9e3', '#dbf0e0', '#f4dadb', '#f4dadb', '#f5f5f5'],
  pattern: ['#494949', '#bcc3c9', '#e9acf8', '#bd63d3', '#6681ee', '#6fbbf8', '#fecb92', '#f78438', '#39a785', '#65cb78', '#fe9e9e', '#e55959', '#f9f9f9'],
  noteFill: ['#FCE19C', '#C0CAD3', '#DFB0F9', '#DB91FD', '#8AA3FF', '#9BC4FD', '#FED49A', '#FAA475', '#6FC896', '#98D08A', '#F7A5A1', '#FC8282', '#FFFFFF'],
  noteText: ['#000000', '#000000', '#000000', '#000000', '#000000', '#000000', '#000000', '#000000', '#000000', '#000000', '#000000', '#000000', '#000000'],
...
const DARK: Record<ShapeColorVariant, string[]> = {
  solid: ['#f2f2f2', '#9398b0', '#e599f7', '#ae3ec9', '#4f72fc', '#4dabf7', '#ffc034', '#f76707', '#099268', '#40c057', '#ff8787', '#e03131', '#f3f3f3'],
  fill: ['#f2f2f2', '#9398b0', '#e599f7', '#ae3ec9', '#4f72fc', '#4dabf7', '#ffc034', '#f76707', '#099268', '#40c057', '#ff8787', '#e03131', '#f3f3f3'],
  linedFill: ['#ffffff', '#8388a5', '#dc71f4', '#8f2fa7', '#3c5cdd', '#2793ec', '#ffae00', '#f54900', '#087856', '#37a44b', '#ff6666', '#c31d1d', '#f3f3f3'],
  semi: ['#2c3036', '#33373c', '#383442', '#342938', '#262d40', '#2a3642', '#3b352b', '#3b2e27', '#253231', '#2a3830', '#3c2b2b', '#382726', '#f5f5f5'],
  pattern: ['#989898', '#7c8187', '#9770a9', '#763a8b', '#3a4b9e', '#4d7aa9', '#fecb92', '#9f552d', '#366a53', '#4e874e', '#a56767', '#8f3734', '#f9f9f9'],
...
export function shapeColor(editor: ShapeEditor | undefined, color: CrewColorStyle, variant: ShapeColorVariant = 'solid'): string {
