...
export class LineShapeUtil extends ShapeUtil<LineShape> {
  ...
  component(shape: LineShape): ReactNode {
    ...
    return createElement('svg', { width: '100%', height: '100%', style: { overflow: 'visible', pointerEvents: 'all' } }, createElement('path', { d: this.getGeometry(shape).toSimpleSvgPath(), fill: 'none', stroke: shapeColor(this.editor, shape.props.color), strokeWidth: width, strokeDasharray: dash, strokeLinecap: 'round', strokeLinejoin: 'round' }))
  }
}
