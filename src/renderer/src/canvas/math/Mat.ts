...
export class Mat {
  ...
  static Multiply(m1: MatLike, m2: MatLike): MatModel {
    return {
  ...
  static Inverse(m: MatLike): MatModel {
  ...
  static Decompose(m: MatLike): DecomposedMat {
    ...
    return { x: m.e, y: m.f, scaleX, scaleY, rotation: clampRadians(rotation) }
  }

  static Smooth(m: MatModel, precision = 10000000000): MatModel {
