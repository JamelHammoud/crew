...
export const DESIGN_NODE_GUIDE = [
  ...
  `4. Use crew's palette. Surfaces ${CREW_SWATCHES.slice(0, 4)
    .map(s => s.hex)
    .join(
      ', '
    )}. Text #ffffff, #b3b3b3, #707070, #4a4a4a. Hairlines #ffffff14. White is the only action color, so a primary button is a white fill with #141414 text. #4ade80 and #f87171 are status only. No purple, no pink, no invented hue.`,
