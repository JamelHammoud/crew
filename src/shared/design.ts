...
export const DESIGN_NODE_GUIDE = [
  ...
  ``,
  `The shape kinds above are sketching tools. When you are asked to design an interface, a screen, a component, or anything that should look finished, use nodes instead. A node is a box with real design properties: any hex color, gradients, corner radius, borders, shadows, blur, glass, typography, and auto layout.`,
  ``,
  ...
  ``,
  `Paints: solid, linear, radial, glass. Fills are a stack, first paint is on top.`,
  `  glass: {"type":"glass","tint":"#ffffff14","blur":24,"opacity":1} gives a frosted panel that blurs whatever sits behind it.`,
  ...
  `8. Glass needs something behind it. Put a gradient or an image under a glass panel or it reads as flat grey.`,
