...
- A build run from source wears a blueprint of the same three discs: ruled paper with a little grain, and the discs lit like glass, blue on near black in dark and white on blue in light. It is the one place in the project that is blue, so a dev window is never mistaken for the installed app sitting beside it in the dock.
